...
function DreamTeam() {
    ...
    return (
        <div className="m-auto bg-[length:1210px_890px] max-[850px]:bg-[length:938px_690px] max-[635px]:bg-[length:625px_460px] bg-no-repeat bg-top bg-[url('https://fantasy.premierleague.com/static/media/pitch-default.dab51b01.svg')]">
